...
class AdminController extends Controller
{
    ...
    public function storeAnimal(Request $request)
    {
        ...
        if ($request->hasFile('Anim_foto')) {
            ...
            $file->storeAs('public/animals', $filename);
    ...
    public function updateAnimal(Request $request, $id)
    {
        ...
        if ($request->hasFile('Anim_foto')) {
            if ($animal->Anim_foto && Storage::exists('public/animals/' . $animal->Anim_foto)) {
                Storage::delete('public/animals/' . $animal->Anim_foto);
            }
            $file = $request->file('Anim_foto');
            $filename = time() . '.' . $file->getClientOriginalExtension();
            $file->storeAs('public/animals', $filename);
    ...
    public function updateProduct(Request $request, $id)
    {
        ...
        if ($request->hasFile('prod_imagen')) {
            if ($product->prod_imagen && Storage::exists('public/products/' . $product->prod_imagen)) {
                Storage::delete('public/products/' . $product->prod_imagen);
            }
            $file = $request->file('prod_imagen');
            $filename = time() . '.' . $file->getClientOriginalExtension();
            $file->storeAs('public/products', $filename);
