...
@section('content')
    <section class="adopta-section">
        <section class="banner-quienes">
            <div class="page-hero-badge">🐾 Adopta con corazón</div>
            <h2>Adopta un Amigo</h2>
            <p class="page-hero-copy">Encuentra el compañero perfecto para tu hogar y transforma dos vidas con una sola
                decisión.</p>
            <div class="page-hero-actions">
                <a href="{{ route('about') }}" class="page-hero-btn">Conoce nuestra historia</a>
                <a href="{{ route('products.public') }}" class="page-hero-btn page-hero-btn-secondary">Ver productos</a>
            </div>
        </section>

        <div class="page-section-grid">
            <div class="seccion page-highlight">
                <h3>Tu próxima historia comienza aquí</h3>
                <p>Explora a nuestros peluditos disponibles y encuentra a quien te acompañará por mucho tiempo.</p>
            </div>
            <div class="seccion">
                <h3>Proceso sencillo</h3>
                <p>Te guiamos paso a paso para que la adopción sea segura, transparente y llena de amor.</p>
            </div>
        </div>
                    ...
                    <div class="premium-card">
                        ...
                        <div>
                            ...
                            <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                                <a href="{{ route('adopter.adoption.create', $animal->Anim_id) }}" class="premium-btn-adopter"
                                    style="flex: 1; text-align: center;">
                                    ¡Quiero Adoptarlo! ❤️
                                </a>
                                <button onclick="openAnimalMedicalHistory({{ $animal->Anim_id }}, this.dataset.animal)" data-animal="{{ json_encode([
        ...
        <div id="animalMedicalHistoryModal"
            ...
            <div
                style="background: white; border-radius: 12px; max-width: 700px; width: 90%; max-height: 80vh; overflow-y: auto; padding: 30px; box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h2 id="animalModalTitle" style="margin: 0; color: #1e7e34;">📋 Historial Médico</h2>
                    <button onclick="closeAnimalMedicalHistory()"
                        style="background: #e2e8f0; border: none; border-radius: 50%; width: 40px; height: 40px; font-size: 20px; cursor: pointer; display: flex; align-items: center; justify-content: center;">✕</button>
                </div>
                ...
                <div style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #e2e8f0; text-align: right;">
                    <button onclick="closeAnimalMedicalHistory()"
                        style="background: #1e7e34; color: white; padding: 10px 20px; border: none; border-radius: 6px; font-weight: bold; cursor: pointer;">Cerrar</button>
                </div>
            </div>
        </div>
