    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-content">
                <h3>Animales Bajo Cuidado</h3>
                <div class="stat-value">{{ $stats['animals_under_care'] ?? 0 }}</div>
                <a href="{{ route('vet.animals') }}" class="action-button" style="margin-top: 10px;">Ver detalles</a>
            </div>
        </div>
        ...
        <div class="stat-card pending">
            ...
            <div class="stat-content">
                ...
                <a href="{{ route('vet.tasks') }}" class="action-button" style="margin-top: 10px;">Ver tareas</a>
            </div>
        </div>
        ...
        <div class="stat-card completed">
            ...
            <div class="stat-content">
                ...
                <small style="color: #999;">{{ $stats['completion_percentage'] ?? 0 }}% del total</small>
            </div>
        </div>
