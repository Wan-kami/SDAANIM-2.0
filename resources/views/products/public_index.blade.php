...
@section('content')
    ...
    <div class="products-page-wrapper">
        ...
        <section class="banner-quienes">
            <div class="page-hero-badge">🛍️ Tienda solidaria</div>
            <h2>Catálogo de Productos</h2>
            <p>Encuentra todo lo que necesitas para cuidar a tus mascotas y apoyar de forma directa a nuestra causa.</p>
            <div class="page-hero-actions">
                <a href="{{ route('cart.view') }}" class="page-hero-btn">🛒 Ver Carrito</a>
                <a href="{{ route('business') }}" class="page-hero-btn page-hero-btn-secondary">Conocer el modelo</a>
            </div>
        </section>
