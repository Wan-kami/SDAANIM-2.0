    ...
    <div class="role-page">
        ...
        <div class="role-hero">
            <div>
                ...
                <p>Ayuda con el cuidado, transporte, alimentación y bienestar de los animales. Tú puedes ser la diferencia
                    para perros y gatos que necesitan compañía, amor y atención.</p>
            ...
            <div class="hero-card">
                <img src="{{ asset('img/Volun.jpg') }}" alt="Voluntario"
        ...
        <div class="form-modal-card vol">
            ...
            <form action="{{ route('inscriptions.store') }}" method="POST">
                ...
                <div class="role-form" style="padding: 0; background: none; box-shadow: none;">
                    ...
                    <textarea id="vol_comentario" name="ins_comentario"
                        placeholder="¿Tienes experiencia con animales? ¿También puedes apoyar con logística?">{{ old('ins_comentario') }}</textarea>
