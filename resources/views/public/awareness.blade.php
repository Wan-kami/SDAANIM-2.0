...
@section('content')
    ...
    <main class="quienes-somos">
        ...
        <section class="banner-quienes" style="background: linear-gradient(135deg, #7c3aed 0%, #a855f7 60%, #c084fc 100%);">
            <div class="page-hero-badge">🐾 Cuidado responsable</div>
            ...
            <div class="page-hero-actions">
                <a href="{{ route('adopta') }}" class="page-hero-btn">Conocer animales</a>
                <a href="{{ route('inscriptions.volunteer') }}" class="page-hero-btn page-hero-btn-secondary">Ser
                    voluntario</a>
            </div>
        </section>
        ...
        <div class="page-section-grid">
            ...
            <div class="seccion" style="border-left-color:#ef4444; background:#fff5f5;">
                ...
                <p>Proporciona alimento balanceado y de calidad según la edad, tamaño y raza de tu mascota. Evita alimentos
                    humanos como chocolate, cebolla o uva — son tóxicos para ellos. Mantén agua fresca disponible todo el
                    día.</p>
            ...
            <div class="seccion" style="border-left-color:#2563eb; background:#eff6ff;">
                ...
                <p>Las vacunas son fundamentales para proteger a tu mascota de enfermedades graves. Lleva un calendario de
                    vacunación y desparasitación. Las visitas regulares al veterinario previenen problemas graves.</p>
            ...
            <div class="seccion" style="border-left-color:#10b981; background:#ecfdf5;">
                ...
                <p>Las mascotas necesitan ejercicio diario para mantenerse sanas y felices. Los paseos fortalecen el vínculo
                    entre tú y tu mascota, reducen el estrés y evitan comportamientos destructivos por aburrimiento.</p>
            ...
            <div class="seccion" style="border-left-color:#f59e0b; background:#fffbeb;">
                ...
                <p>Mantener limpia a tu mascota es parte de su salud. El baño periódico, el cepillado del pelo y la limpieza
                    de orejas y dientes previenen infecciones y mantienen a tu peludito cómodo y saludable.</p>
            ...
            <div class="seccion" style="border-left-color:#ec4899; background:#fdf2f8;">
                ...
                <p>Las mascotas son seres sociales que necesitan afecto, atención y compañía. Dedica tiempo de calidad cada
                    día. Evita dejarlos solos por períodos prolongados y respeta su espacio cuando lo necesiten.</p>
            ...
            <div class="seccion" style="border-left-color:#8b5cf6; background:#f5f3ff;">
                ...
                <p>Esterilizar a tu mascota contribuye a controlar la sobrepoblación animal y tiene beneficios directos para
                    su salud: reduce el riesgo de ciertos cánceres y comportamientos agresivos. ¡Es un acto de
                    responsabilidad!</p>
        ...
        <section class="seccion" style="border-left-color:#7c3aed; background:#f5f3ff;">
            ...
            <div id="faqList" style="margin-top:12px;">
                ...
                <details style="border-radius:10px; border:1px solid #ddd6fe; margin-bottom:10px; overflow:hidden;">
                    <summary
                        style="padding:14px 18px; cursor:pointer; font-weight:700; color:#3730a3; background:#ede9fe; list-style:none; display:flex; justify-content:space-between;">
                        ¿Puedo adoptar si vivo en apartamento? <span>▾</span>
                    </summary>
                    <p
                        style="padding:14px 18px; color:#4c1d95; margin:0; background:#fff; font-size:0.93em; line-height:1.7;">
                        ¡Sí! Lo más importante es el amor y la dedicación que brindes. Para perros de razas medianas o
                        grandes recomendamos asegurar paseos diarios frecuentes. Tenemos muchos perros pequeños perfectos
                        para apartamento.
                    </p>
                </details>
                ...
                <details style="border-radius:10px; border:1px solid #ddd6fe; margin-bottom:10px; overflow:hidden;">
                    ...
                    <p
                        style="padding:14px 18px; color:#4c1d95; margin:0; background:#fff; font-size:0.93em; line-height:1.7;">
                        La adopción es gratuita. Sí pedimos que el animal cuente con sus vacunas al día y sea esterilizado
                        si aún no lo está. Nuestro equipo te orientará en cada paso.
                    </p>
                </details>
                ...
                <details style="border-radius:10px; border:1px solid #ddd6fe; margin-bottom:10px; overflow:hidden;">
                    ...
                    <p
                        style="padding:14px 18px; color:#4c1d95; margin:0; background:#fff; font-size:0.93em; line-height:1.7;">
                        El proceso incluye el formulario de solicitud, una visita a tu hogar por parte de un voluntario y la
                        revisión final. Puede tomar entre 1 y 3 semanas dependiendo de la disponibilidad y el caso.
                    </p>
                </details>
                ...
                <details style="border-radius:10px; border:1px solid #ddd6fe; overflow:hidden;">
                    ...
                    <p
                        style="padding:14px 18px; color:#4c1d95; margin:0; background:#fff; font-size:0.93em; line-height:1.7;">
                        Por favor, comunícate con nosotros antes de tomar cualquier decisión. Estamos para ayudarte. El
                        animal puede regresar a nuestro refugio y buscaremos una nueva familia amorosa para él.
                    </p>
                </details>
