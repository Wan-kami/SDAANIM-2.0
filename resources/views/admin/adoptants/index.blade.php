...
<div class="adoptants-container">
    ...
    <div class="table-card">
        <div class="table-stats">
            <span class="stat-badge">Total: <strong>{{ $adoptants->count() }}</strong> adoptante{{ $adoptants->count() !== 1 ? 's' : '' }}</span>
        </div>
...
<style>
    ...
    .col-document { width: 150px; }
    .col-name { width: 200px; }
    .col-email { width: 250px; }
    .col-phone { width: 140px; }
    .col-address { flex: 1; min-width: 200px; }
    ...
    @media (max-width: 768px) {
        ...
        .col-document:before { content: "DOCUMENTO"; }
        .col-name:before { content: "NOMBRE"; }
        .col-email:before { content: "EMAIL"; }
        .col-phone:before { content: "TELÉFONO"; }
        .col-address:before { content: "DIRECCIÓN"; display: block; }
        .col-address { display: block; }
    }
</style>
@endsection
